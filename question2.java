...
public class question2 {
    public static void main(String[] args) {
        ...
        int pizza_Price = Math.abs(pizza) * 100;
        int puffs_Price = Math.abs(puffs) * 20;
        int cooldrinks_Price = Math.abs(cooldrinks) * 10;
        
        System.out.println("No of pizzas:" + pizza);
        System.out.println("No of puffs:" + puffs);
        System.out.println("No of cooldrinks:" + cooldrinks);

        int totalPrice = pizza_Price + puffs_Price + cooldrinks_Price;
